...
/*
 * Clase configuradora de la conexión con la base de datos
 * a partir de los parametros de accesos configurados en el archivo credentials.json
*/
